...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typV.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/v/type_v_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typV .moveAble {
        border-radius: 0px;
    }
</style>
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="v"/>
    ...
    <div class="wrapper-inside typV <?php echo $this->data['current_month']; ?>">
