...
<style type="text/css">
    ...
    .cal-dynamic-holder .wrapper-inside.typG.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/g/type_g_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typG .moveAble {
        border-radius: 0px;
    }
</style>
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="g"/>
    ...
    <div class="wrapper-inside typG <?php echo $this->data['current_month']; ?>">
