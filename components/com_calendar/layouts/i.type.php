...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typI.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/i/type_i_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typI .moveAble {
        border-radius: 0px;
    }

    .month.month-<?php echo $this->data['current_month'];?> {
        background-color: rgba(0, 0, 0, 0);
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/i/type_i_<?php echo $urlAffixMonth ?>_0.png");
				background-repeat: no-repeat;
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="i"/>
    ...
    <div class="wrapper-inside typI <?php echo $this->data['current_month']; ?>">
