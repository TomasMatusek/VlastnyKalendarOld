...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typA.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/a/type_a_<?php echo $urlAffix ?>_0.jpg");
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="a"/>
    ...
    <div class="wrapper-inside typA <?php echo $this->data['current_month']; ?>">
