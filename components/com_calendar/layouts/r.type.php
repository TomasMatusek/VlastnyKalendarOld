...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typR.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/r/type_r_<?php echo $urlAffix ?>_0.jpg");
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="r"/>
    ...
    <div class="wrapper-inside typR <?php echo $this->data['current_month']; ?>">
