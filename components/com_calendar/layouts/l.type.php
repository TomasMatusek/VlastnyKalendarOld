...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typL.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/l/type_l_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typL .moveAble {
        border-radius: 0px;
    }

    .month.month-<?php echo $this->data['current_month'];?> {
        background-color: rgba(0, 0, 0, 0);
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/l/type_l_<?php echo $urlAffixMonth ?>_0.png");
        background-position: center center;
        background-repeat: no-repeat;
    }
</style>
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="l"/>
    ...
    <div class="wrapper-inside typL <?php echo $this->data['current_month']; ?>">
