...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typQ.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/q/type_q_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typQ .moveAble {
        border-radius: 0px;
    }
</style>
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="q"/>
    ...
    <div class="wrapper-inside typQ <?php echo $this->data['current_month']; ?>">
