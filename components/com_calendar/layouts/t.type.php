...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typT.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/t/type_t_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typT .moveAble {
        border-radius: 0px;
    }
</style>
...
<div class="cal-dynamic-holder">
    ...
    <div class="wrapper-inside typT <?php echo $this->data['current_month']; ?>">
