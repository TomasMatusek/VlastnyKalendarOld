...
<style type="text/css">
    .cal-dynamic-holder .wrapper-inside.typJ.<?php echo $this->data['current_month']; ?> {
        background-color: white;
        background-image: url("https://www.vlastnykalendar.sk/components/com_calendar/assets/img/calendars/preview/j/type_j_<?php echo $urlAffix ?>_0.jpg");
    ...
    .cal-dynamic-holder .wrapper-inside.typJ .moveAble {
        border-radius: 0px;
    }
</style>
...
<div class="cal-dynamic-holder">
    <input type="hidden" name="cal_type" value="j"/>
    ...
    <div class="wrapper-inside typJ <?php echo $this->data['current_month']; ?>">
