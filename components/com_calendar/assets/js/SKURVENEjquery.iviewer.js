...
//		console.log(x); //left
    ...
    **/
    set_zoom: function(new_zoom, skip_animation)
    {
		...
		console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		console.log("New zoom 1: "+new_zoom);
		console.log("Zoom min: "+this.options.zoom_min);
		console.log("Zoom max: "+this.options.zoom_max);
		...
		console.log('CURRENT ZOOM: '+this.current_zoom);
		 if(this.current_zoom == "load")
        {
            var new_width = this.options.width;
   			var new_height = this.options.height;
            this.current_zoom = 100;
        }
        else {
...
//		console.log(new_height);
		...
		var width_element =  $(this.options.width_element);
		var height_element =  $(this.options.height_element);
		width_element.val(this.options.img_width);
		height_element.val(this.options.img_height);
